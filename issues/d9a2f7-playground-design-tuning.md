...
- [x] **デザイン思想・原則を `docs/design-principles.md` に文書化**（身体性を背骨に P1–P5＋新 UI 用チェックリスト）。
      具体仕様（バッジ mono/tint/brand・光学サイズ補正・cap 中心整列・影の負 spread・positional/raking light）は
      `docs/status-card-design.md` に適用値として保持し、原則↔具体を相互リンク。
